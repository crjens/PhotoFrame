...
exports.sync = function (options, srcFileCallback, tgtFileCallback) {

    console.log("Called Exports.Sync");
    SyncRepeat(options, srcFileCallback, tgtFileCallback);
};

var SyncRepeat = function (options, srcFileCallback, tgtFileCallback) {
    try {
        SyncFiles(options, srcFileCallback, tgtFileCallback, function (err) {
            if (err)
                console.log("error syncing files: " + err);

            setTimeout(SyncRepeat, options.delay, options, srcFileCallback, tgtFileCallback);
        });
    }
    catch (e) {
...
var SyncFiles = function (options, srcFileCallback, tgtFileCallback, callback) {
    ...
    existsFunction(options.srcPath, function (srcPathExists) {
        if (srcPathExists) {
            ...
            walk(options.srcPath, options, function (err) {
                ...
                walk(options.tgtPath, options, callback, tgtFileCallback);
            }, srcFileCallback);
